          ...
          <div>
            ...
            <main>
              <Switch>
                ...
                <Route path='/channels/:streamId' render={(props) => { return <ChannelPlayer streamId={props.match.params.streamId} isHls={isIOS} local={false} />}} />
                <Route path='/hls/:streamId' render={(props) => { return <ChannelPlayer streamId={props.match.params.streamId} isHls={true} local={false} />}} />
                <Route path='/local/:streamId' render={(props) => { return <ChannelPlayer streamId={props.match.params.streamId} isHls={true} local={true} />}} />
              </Switch>
            </main>
          </div>
        </div>
